...
track_courses = {
    "항공드론 초급": {
        "required": [
            ("항공우주학개론", 2), ("항공우주산업개론", 2), ("드론테크노비즈니스개론", 3), ("혁신융합세미나(항공드론)", 1),
    ...
    "항공드론 활용 및 MRO 심화": {
        ...
        "or_groups": [
            [("전기전자공학", 3), ("회로이론1", 3), ("전기전자개론및실습", 3), ("기초전자실험", 3)]
        ]
    }
}
...
st.markdown(
    ...
    예: <span style="color:green;">항공우주산업개론,AI프로그래밍,재료과학1 / 틀린예: 임베디드 SW입문, 재료과학Ⅰ</span><br><br>
    !추가로 필요한 수강학점이 적은 순으로 추천됩니다!<br>
    !25-2학기 기준입니다. 내년에는 이수해야 할 교과목이 달라질 수 있습니다!
    </p>
    """,
